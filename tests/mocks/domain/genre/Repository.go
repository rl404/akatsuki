...
import (
	...
	entity "github.com/rl404/akatsuki/internal/domain/genre/entity"
...
func (_m *Repository) BatchUpdate(ctx context.Context, data []entity.Genre) (int, error) {
	...
	var r0 int
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []entity.Genre) (int, error)); ok {
		return rf(ctx, data)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []entity.Genre) int); ok {
		r0 = rf(ctx, data)
	} else {
		r0 = ret.Get(0).(int)
	}
...
func (_m *Repository) Get(ctx context.Context, data entity.GetRequest) ([]*entity.Genre, int, int, error) {
	ret := _m.Called(ctx, data)
	...
	var r2 int
	var r3 error
	if rf, ok := ret.Get(0).(func(context.Context, entity.GetRequest) ([]*entity.Genre, int, int, error)); ok {
		return rf(ctx, data)
	}
	if rf, ok := ret.Get(0).(func(context.Context, entity.GetRequest) []*entity.Genre); ok {
		r0 = rf(ctx, data)
	} else {
		if ret.Get(0) != nil {
...
func (_m *Repository) GetByID(ctx context.Context, id int64) (*entity.Genre, int, error) {
	...
	var r1 int
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, int64) (*entity.Genre, int, error)); ok {
		return rf(ctx, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int64) *entity.Genre); ok {
		r0 = rf(ctx, id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*entity.Genre)
...
func (_m *Repository) GetByIDs(ctx context.Context, ids []int64) ([]*entity.Genre, int, error) {
